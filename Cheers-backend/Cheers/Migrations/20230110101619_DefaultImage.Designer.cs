...
namespace Cheers.Migrations
{
    ...
    [Migration("20230110101619_DefaultImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cheers.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Cheers.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cheers.Models.Idea", b =>
                {
                    b.HasOne("Cheers.Models.ApplicationUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Cheers.Models.ApplicationUser", null)
                        .WithMany()
